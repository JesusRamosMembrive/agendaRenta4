...
class BatchQualityCheckRunner:
    ...
    def __init__(self, batch_type: str, checker_class, checker_config: Optional[Dict] = None):
        """
    ...
    def run_batch(self, section_ids: List[int], created_by: str = "system") -> Dict[str, Any]:
        """
        ...
        try:
            ...
            for section_id in section_ids:
                try:
                    ...
                    logger.info(f"✓ {section['url']}: {result.status} (score: {result.score})")
